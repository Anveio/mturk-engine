...
export const BLOCK_HIT = 'BLOCK_HIT';
export type BLOCK_HIT = typeof BLOCK_HIT;
...
export const UNBLOCK_MULTIPLE_REQUESTERS = 'UNBLOCK_MULTIPLE_REQUESTERS';
export type UNBLOCK_MULTIPLE_REQUESTERS = typeof UNBLOCK_MULTIPLE_REQUESTERS;
